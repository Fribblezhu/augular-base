...
export class AuthService {
  ...
  public login(authInfo: {}): Observable<RestResponse> {
    return this.http.post<RestResponse>(this.appConfig.apiUrl + this.appConfig.LOGIN_URL, authInfo, {})
      .pipe(
          catchError(this.handleError('login', {} as RestResponse)),
          tap(
  ...
  public getUser(): Observable<RestResponse> {
    return this.http.get<RestResponse>(this.appConfig.apiUrl + this.appConfig.GET_USER_URL, {})
      .pipe(
        catchError(this.handleError('getUser' , {} as RestResponse)),
      );
  }

  public hasRole(): Observable<RestResponse> {
    return this.http.get < RestResponse>(this.appConfig.apiUrl + this.appConfig.HAS_ROLE, {})
      .pipe(
        catchError(this.handleError('hasRole', {} as RestResponse))
      );
  }
}
